...
class Balance:
    def __init__(self, info, exchange):
        if exchange == "binance":
            ...
            self.unrealised_pnl = info['unrealisedPnl'] * BITMEX_MULTIPLIER
        elif exchange == "kuCoin":
            self.account_equity = info['accountEquity']
            self.unrealised_pnl = info['unrealisedPNL']
            self.margin_balance = info['marginBalance']
            self.position_margin = info['positionMargin']
            self.available_balance = info['availableBalance']
